...
public enum ErrorCode {
    ...
    AUTHENTICATION_FAILED("AUTH_001", "Authentication failed", "Authentication failed", HttpStatus.UNAUTHORIZED),
    ...
    // Payment Errors
    ORDER_NOT_OWNED("PAYMENT_001", "Order Not Owned", "Order does not belong to the user", HttpStatus.FORBIDDEN),
    PAYMENT_AMOUNT_MISMATCH("PAYMENT_002", "Payment Amount Mismatch", "Payment amount does not match order total", HttpStatus.BAD_REQUEST),
    ORDER_UPDATE_FAILED("PAYMENT_003", "Order Update Failed", "Failed to update order status", HttpStatus.INTERNAL_SERVER_ERROR),
